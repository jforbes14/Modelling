...
We now add interactions to our model. The selection criteria is having an interaction that significantly improves the model in at least half of the elections (at the 1% significance level). We add the most common interaction, and then re-run.

First added in the interaction between OtherLanguageHome and Extractive.

```{r}
fit_ss_16_1 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive, 
                data = data_mod %>% 
                  filter(year == "2016") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_13_1 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive, 
                data = data_mod %>% 
                  filter(year == "2013") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_10_1 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive, 
                data = data_mod %>% 
                  filter(year == "2010") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_07_1 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive, 
                data = data_mod %>% 
                  filter(year == "2007") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_04_1 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive, 
                data = data_mod %>% 
                  filter(year == "2004") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_01_1 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive, 
                data = data_mod %>% 
                  filter(year == "2001") %>% 
                  select(Perc_LNP, (superset$varname %>% as.character)))
...
# Interactions
int16_1 <- interact_F(fit_ss_16_1) %>% mutate(year = "2016")
int13_1 <- interact_F(fit_ss_13_1) %>% mutate(year = "2013") 
int10_1 <- interact_F(fit_ss_10_1) %>% mutate(year = "2010") 
int07_1 <- interact_F(fit_ss_07_1) %>% mutate(year = "2007") 
int04_1 <- interact_F(fit_ss_04_1) %>% mutate(year = "2004") 
int01_1 <- interact_F(fit_ss_01_1) %>% mutate(year = "2001") 
...
Now Education and OneParent_House is the only interaction significant in more than half, so we add.

```{r}
fit_ss_16_2 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House, 
                data = data_mod %>% 
                  filter(year == "2016") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_13_2 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House, 
                data = data_mod %>% 
                  filter(year == "2013") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_10_2 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House, 
                data = data_mod %>% 
                  filter(year == "2010") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_07_2 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House, 
                data = data_mod %>% 
                  filter(year == "2007") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_04_2 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House, 
                data = data_mod %>% 
                  filter(year == "2004") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_01_2 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House, 
                data = data_mod %>% 
                  filter(year == "2001") %>% 
                  select(Perc_LNP, (superset$varname %>% as.character)))
...
# Interactions
int16_2 <- interact_F(fit_ss_16_2) %>% mutate(year = "2016")
int13_2 <- interact_F(fit_ss_13_2) %>% mutate(year = "2013") 
int10_2 <- interact_F(fit_ss_10_2) %>% mutate(year = "2010") 
int07_2 <- interact_F(fit_ss_07_2) %>% mutate(year = "2007") 
int04_2 <- interact_F(fit_ss_04_2) %>% mutate(year = "2004") 
int01_2 <- interact_F(fit_ss_01_2) %>% mutate(year = "2001") 
...
Education and ManagerAdminClericalSales

```{r}
fit_ss_16_3 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House + Educ:ManagerAdminClericalSales, 
                data = data_mod %>% 
                  filter(year == "2016") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_13_3 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House + Educ:ManagerAdminClericalSales, 
                data = data_mod %>% 
                  filter(year == "2013") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_10_3 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House + Educ:ManagerAdminClericalSales, 
                data = data_mod %>% 
                  filter(year == "2010") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_07_3 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House + Educ:ManagerAdminClericalSales, 
                data = data_mod %>% 
                  filter(year == "2007") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_04_3 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House + Educ:ManagerAdminClericalSales, 
                data = data_mod %>% 
                  filter(year == "2004") %>% 
                  select(Perc_LNP,  (superset$varname %>% as.character)))

fit_ss_01_3 <- lm(Perc_LNP ~ . + OtherLanguageHome:Extractive + Educ:OneParent_House + Educ:ManagerAdminClericalSales, 
                data = data_mod %>% 
                  filter(year == "2001") %>% 
                  select(Perc_LNP, (superset$varname %>% as.character)))
...
# Interactions
int16_3 <- interact_F(fit_ss_16_3) %>% mutate(year = "2016")
int13_3 <- interact_F(fit_ss_13_3) %>% mutate(year = "2013") 
int10_3 <- interact_F(fit_ss_10_3) %>% mutate(year = "2010") 
int07_3 <- interact_F(fit_ss_07_3) %>% mutate(year = "2007") 
int04_3 <- interact_F(fit_ss_04_3) %>% mutate(year = "2004") 
int01_3 <- interact_F(fit_ss_01_3) %>% mutate(year = "2001") 
...
We refrain from adding more interactions to avoid overfitting, being mindful of limiting parameters due to having 150 observations each election.


Now saving models with the same name as before
```{r}
fit_ss_16 <- fit_ss_16_3
fit_ss_13 <- fit_ss_13_3
fit_ss_10 <- fit_ss_10_3
fit_ss_07 <- fit_ss_07_3
fit_ss_04 <- fit_ss_04_3
fit_ss_01 <- fit_ss_01_3
```
...
Residuals look good. Possibly fat lower tails in 2004, 2007 and 2010.
...
Perhaps could add a quadratic term for NoReligion, to capture the drop seen in 2013 and 2016.
...
2016: Anglican perhaps
2013: Anglican perhaps
2010: Anglican perhaps
2007: None
2004: None
2001: None
