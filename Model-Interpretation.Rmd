...
#  scale_fill_gradient2(low = "#ff0000", mid = "white", high = "#3366ff", midpoint = 50) 
  scale_fill_gradientn(colours = c("#ff0000", "#ff6666", "#ff6666", "white", "#668cff", "#668cff", "#3366ff"), 
